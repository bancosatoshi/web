...
const Description: React.FC<TypographyProps> = ({ children, className, inline, ...props }) => (
  <p className={clsx(styles.typography__description, className, { [styles.typography__inline]: inline })} {...props}>
    {children}
  </p>
);
