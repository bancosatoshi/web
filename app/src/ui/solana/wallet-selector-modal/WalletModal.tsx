  ...
  return (
    ...
    createPortal(
      ...
      >
          ...
          <div className={`wallet-adapter-modal-wrapper ${!logo && "wallet-adapter-modal-wrapper-no-logo"}`}>
            {logo && (
              <div className="wallet-adapter-modal-logo-wrapper">
                {typeof logo === "string" ? <img alt="logo" className="wallet-adapter-modal-logo" src={logo} /> : logo}
              </div>
            )}
            <h1 className="wallet-adapter-modal-title" id="wallet-adapter-modal-title">
              Connect Wallet
            </h1>
            <Button onClick={handleClose} className="wallet-adapter-modal-button-close" variant="text">
        ...
        <div className="wallet-adapter-modal-overlay" onMouseDown={handleClose} role="presentation" />
      </div>,
      portal,
    )
  );
